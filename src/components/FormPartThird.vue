<template>
    <CForm class="align-items-start form-block">
        ...
        <CFormInput
            ...
            v-model.trim="state.addressClient"
            @change="v$.addressClient.$touch"
            :valid="v$.addressClient.$dirty && !v$.addressClient.$error"
            :invalid="v$.addressClient.$dirty && v$.addressClient.$error"
        />
        <CFormInput
